      ...
      <div className="w-full max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <ScrollRevealStagger staggerDelay={0.12}>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {studies.map((item) => (
              <ScrollRevealItem key={item.id} variant="fade-up" duration={0.7}>
                <div className="group flex flex-col bg-[#F4EFEB] rounded-lg overflow-hidden border border-[#2C2523]/8 transition-all duration-500 hover:shadow-editorial hover:-translate-y-1">
                  {/* Image Frame */}
