      ...
      <div className="max-w-4xl mx-auto px-6 sm:px-8">
        <div className="space-y-16 sm:space-y-20">
          {photographerData.storyBlocks.map((block, index) => (
            <ScrollReveal key={block.heading} variant="fade-up" duration={0.8}>
              <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-12 items-baseline pt-10 first:pt-0 border-t border-[#2C2523]/10 first:border-t-0">
                {/* Heading */}
