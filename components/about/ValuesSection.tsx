      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
          {photographerData.values.map((v) => (
            <div
              key={v.title}
              className="group flex flex-col sm:flex-row bg-[#FAF8F5] rounded-lg overflow-hidden border border-[#2C2523]/10 shadow-subtle hover:shadow-editorial transition-all duration-500 hover:-translate-y-1"
            >
              {v.image && (
